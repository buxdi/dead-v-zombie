Locales['fr'] = {
  ...
  ['unconscious_found'] = '~r~[ALERTE]: Une balise de detresse à été signalée.',
  -- F6 Menu
  ...
  -- Phone
  ['alert_ambulance'] = '~r~[SURVIVANT EN DETRESSE]',
  -- Death
  ['respawn_available_in'] = '                                     ~r~%s : %s',
  ['respawn_bleedout_in'] = '',
  ['respawn_bleedout_prompt'] = '                                        ~r~Maintenir [E] pour être transporter en zone sûre.',
  ['respawn_bleedout_fine'] = 'vous laisserez sur place tout vos objets',
  ['respawn_bleedout_fine_msg'] = 'vous avez payé $%s pour être réanimer.',
  ['distress_send'] = '~r~                                        Appuyez sur [G] pour activer la balise de détresse',
  ['distress_sent'] = '~r~Un signal a été envoyé à tout les survivant !',
  -- Revive
