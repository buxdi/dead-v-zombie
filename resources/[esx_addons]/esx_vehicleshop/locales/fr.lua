Locales['fr'] = {
  ...
  ['buy_vehicle_shop']                = 'Faire fabriqué %s pour $%s?',
  ['buy_vehicle']                     = 'Fabriquation de véhicule',
  ['car_dealer']                      = 'Fabrications',
  ...
  ['shop_menu']                       = '~b~Magasin de véhicule',
  ['generic_shopitem']                = '$%s',
  ['vehicle_dealer']                  = 'Véhicules',
