...
RegisterServerEvent('sp_fueler:startHarvest')
AddEventHandler('sp_fueler:startHarvest', function(zone)
...
RegisterServerEvent('sp_fueler:stopHarvest')
AddEventHandler('sp_fueler:stopHarvest', function()
	local _source = source
...
RegisterServerEvent('sp_fueler:startTransform')
AddEventHandler('sp_fueler:startTransform', function(zone)
	local _source = source
...
RegisterServerEvent('sp_fueler:stopTransform')
AddEventHandler('sp_fueler:stopTransform', function()
...
RegisterServerEvent('sp_fueler:startSell')
AddEventHandler('sp_fueler:startSell', function(zone)
...
RegisterServerEvent('sp_fueler:stopSell')
AddEventHandler('sp_fueler:stopSell', function()
...
RegisterServerEvent('sp_fueler:getStockItem')
AddEventHandler('sp_fueler:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('sp_fueler:getStockItems', function(source, cb)
...
RegisterServerEvent('sp_fueler:putStockItems')
AddEventHandler('sp_fueler:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('sp_fueler:getPlayerInventory', function(source, cb)
