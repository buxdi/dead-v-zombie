 ...
 */
 ...
 jqSimpleConnect.connect = function(elementA, elementB, options) {
    ...
    // console.log(zindex,'connect');
     ...
     jQuery('.skill ').prepend(div.replace('divUniqueIdentifier', connection.id + '_1'));
     jQuery('.skill ').prepend(div.replace('divUniqueIdentifier', connection.id + '_2'));
     jQuery('.skill ').prepend(div.replace('divUniqueIdentifier', connection.id + '_3'));
