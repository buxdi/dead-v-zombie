const app = new Vue({
    ...
    data: {
        ...
        numeriDisplay: [
            {
                numero: 0,
                description: 'Ne s\'affiche jamais nulle part.'
            },
            {
                numero: 1,
                description: 'Ne s\'affiche jamais nulle part.'
            ...
            {
                numero: 2,
                description: 'Affiche à la fois sur la carte principale et sur la mini-carte.'
            },
            {
                numero: 3,
                description: 'Affiche uniquement sur la carte principale.'
            },
            {
                numero: 4,
                description: 'Affiche uniquement sur la carte principale.'
            ...
            {
                numero: 5,
                description: 'Affiche uniquement sur la mini-carte.'
            },
            {
                numero: 6,
                description: 'Affiche à la fois sur la carte principale et sur la mini-carte.'
            ...
            {
                numero: 8,
                description: 'Affiche à la fois sur la carte principale et sur la mini-carte. (Non sélectionnable sur la carte)'
            },
            {
                numero: 9,
                description: 'Affiche uniquement sur la mini-carte.'
