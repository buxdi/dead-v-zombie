PET = {
    ...
    showPetCommand = "petlocal", -- Blip showing the location of the pet
    -- 
    ...
    -- Pet Shop area
    petBuyCoords = vector3(-662.663757, -935.235168, 21.815430), -- purchase marker part of the pet
    petShowCoords = vector4(-661.041748, -937.753845, 21.815430, 138.062988),-- Where to spawn when in the pet purchase menu
    -- SQL 
    Mysql = "oxmysql",
    --NEEDS SYSETM
    ...
    petThirstFillItem = "petwater", -- item to fill pet's thirst
    petThirstFillAmount = 97, -- How much to fill when used --max 97
    -- DEADTH SIDE
    PermanentlyDie = true, -- if "true", the pet will be directly deleted when it dies and will never come back.
    -- UPTADES
